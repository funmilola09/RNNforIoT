...
layerFile = "C:\\Users\\LIFTED\Desktop\\myWORK\\project4\\Intrusion-Detection-System-for-the-Internet-of-Things-master\\Output Files\\Instances.txt"
...
trainingX = reducX[:3162]
trainingY = reducY[:3162]
testingX = reducX[3163:5000]
testingY = reducY[3163:5000]
...
plot.show()
    ...
    # confusion metrics calculations
TP = confusion[0, 0]
FN = confusion[0, 1]
FP = confusion[1, 0]
TN = confusion[1, 1]
...
CMaccuracy = (TP+TN)/(TP+FP+TN+FN)
print ("\nAccuracy:", session.run(CMaccuracy, feed_dict = {x:newTestingX, y:newTestingY}))
